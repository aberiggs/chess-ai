...
def play_ai(ai_color):
    ...
    Test positions
     ...
     8. 8/8/8/8/8/2k5/5ppp/1K6 b - - 11 85
     9. 2N5/pp2Q1kp/4p1p1/8/5r2/P3r2q/1P4RP/6KR b - - 9 34"
    10. "rnbqkb1r/pppppppp/5n2/4P3/8/8/PPPP1PPP/RNBQKBNR b KQkq - 0 2"
    """
    board = chess.Board("rnbqkb1r/pp1ppppp/8/2PnP3/8/8/PPP2PPP/RNBQKBNR b KQkq - 0 4")
    running = True
    selected_square = None
